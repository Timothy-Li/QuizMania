    ...
    return (
      ...
      >
        ...
        >
          ...
          />{" "}
          {/* Increased radius from 30 to 60 */}
          {/* Centered question mark */}
          <g className={styles.questionMark}>
            <circle cx="60" cy="60" r="40" className={styles.questionCircle} />{" "}
            {/* Increased radius from 20 to 40 */}
            <path
              ...
              strokeLinecap="round"
            />
            <circle cx="60" cy="78" r="6" fill="#FFD700" />{" "}
            {/* Increased radius from 3 to 6 */}
          </g>
    ...
    return (
      ...
      >
        ...
        >
          ...
          {/* Centered question mark */}
          <g className={styles.questionMark}>
            <circle cx="60" cy="60" r="24" className={styles.questionCircle} />{" "}
            {/* Increased radius from 12 to 24 */}
            <path
              ...
              strokeLinecap="round"
            />
            <circle cx="58" cy="72" r="3" fill="#FFD700" />{" "}
            {/* Increased radius from 1.5 to 3 */}
          </g>
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Centered question mark */}
        <g className={styles.questionMark}>
          <circle cx="76" cy="70" r="40" className={styles.questionCircle} />{" "}
          {/* Increased radius from 20 to 40 */}
          <path
            ...
            strokeLinecap="round"
          />
          <circle cx="76" cy="88" r="6" fill="#FFD700" />{" "}
          {/* Increased radius from 3 to 6 */}
        </g>
        ...
        <g className={styles.decorativeElements}>
          <circle cx="400" cy="50" r="6" className={styles.dot} />{" "}
          {/* Increased radius from 3 to 6 */}
          <circle cx="416" cy="70" r="6" className={styles.dot} />{" "}
          {/* Increased radius from 3 to 6 */}
          <circle cx="400" cy="90" r="6" className={styles.dot} />{" "}
          {/* Increased radius from 3 to 6 */}
        </g>
      </svg>
    </div>
